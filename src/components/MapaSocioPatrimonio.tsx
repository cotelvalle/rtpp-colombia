...
const pueblosMapInfo: PuebloMapInfo[] = [
  ...
  { id: 'buga', name: 'Guadalajara de Buga', dept: 'Valle del Cauca', region: 'Pacífico / Llanos', coordinates: [-76.30, 3.90], voc: 'Turismo Religioso y Dulces Tradicionales', desc: 'Conocida como la "Ciudad Señora", es la meca del turismo religioso en Colombia y hogar de la majestuosa Basílica del Señor de los Milagros. Su casco histórico preserva una invaluable mezcla de arquitectura colonial y republicana de los siglos XVII y XVIII.' },
